...
from common.networks import get_optimizer
from common.models import EnsembleModel
...
class TransitionModel:
    def __init__(self,
        ...
        self.model_optimizer = get_optimizer(optimizer_class=kwargs['optimizer_class'], network=self.model,
